 ...
 * misattribution — e.g. switching from one runtime floor to another while
 * still connected must NOT stamp the newly active floor as connected to the
 * previous floor's gateway URL.
 */
