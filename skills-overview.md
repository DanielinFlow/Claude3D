# Skills in OpenClaw + Claude3D

This document explains skills from first principles, how they work in the OpenClaw runtime, and how Claude3D currently exposes them in UX.
...
## 10) Claude3D UX (current behavior)
